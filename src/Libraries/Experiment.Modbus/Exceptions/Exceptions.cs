...
namespace Experiment.Modbus.Exceptions{
	/// <summary>
	...
	/// <summary>
	/// Exception to be thrown if Connection to Experiment.Modbus device failed
	/// </summary>
	...
	/// <summary>
	/// Exception to be thrown if Experiment.Modbus Server returns error code "Function code not supported"
	/// </summary>
	...
	/// <summary>
	/// Exception to be thrown if Experiment.Modbus Server returns error code "quantity invalid"
	/// </summary>
	...
	/// <summary>
	/// Exception to be thrown if Experiment.Modbus Server returns error code "starting adddress and quantity invalid"
	/// </summary>
	...
	/// <summary>
	/// Exception to be thrown if Experiment.Modbus Server returns error code "Function Code not executed (0x04)"
	/// </summary>
