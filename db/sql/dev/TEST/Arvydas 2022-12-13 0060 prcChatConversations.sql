DROP PROCEDURE IF EXISTS prcChatConversations
GO

CREATE PROCEDURE prcChatConversations (
	@userId nvarchar(128)
) AS BEGIN
...
SET @userId = N'26b33240-b13e-406d-a2a3-b4e90af3c459'

EXEC prcChatConversations @userId
