/*
   2023 m. kovo 22 d., trečiadienis15:16:20
   User: sa
   Server: TERRA
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.tblDatapointFormula ADD
	Aggregated bit NOT NULL CONSTRAINT DF_tblDatapointFormula_Aggregated DEFAULT 0
GO
